        ...
        <div class="col-8 pe-5 ">
            <div class="isi container">
                ...
                <section class="my-5 d-flex justify-content-around">
                    ...
                    <button type="button" class="btn btn-outline-dark px-3"><a href="/ci4/bab2" id="nextPage"><i class="bi bi-arrow-right-short"></i> Selanjutnya</a></button>
                </section>
            </div>
        </div>
